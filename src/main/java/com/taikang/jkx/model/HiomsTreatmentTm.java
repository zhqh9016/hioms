 ...
 * @author 
 */
public class HiomsTreatmentTm implements Serializable {
    /**
     * 就诊编号
     */
    ...
    private Float benciqiandabingleiji2;

    private Float dabingchongsuan2;

    /**
     * 起付线按一般农户算
     */
    private Float benciqiandabingleiji3;

    /**
     * 按照普通人员政策计算
     */
    private Float dabingchongsuan3;
    ...
    public Float getBenciqiandabingleiji2() {
        return benciqiandabingleiji2;
    }

    public void setBenciqiandabingleiji2(Float benciqiandabingleiji2) {
        this.benciqiandabingleiji2 = benciqiandabingleiji2;
    }

    public Float getDabingchongsuan2() {
        return dabingchongsuan2;
    }

    public void setDabingchongsuan2(Float dabingchongsuan2) {
        this.dabingchongsuan2 = dabingchongsuan2;
    }

    public Float getBenciqiandabingleiji3() {
        return benciqiandabingleiji3;
    }

    public void setBenciqiandabingleiji3(Float benciqiandabingleiji3) {
        this.benciqiandabingleiji3 = benciqiandabingleiji3;
    }

    public Float getDabingchongsuan3() {
        return dabingchongsuan3;
    }

    public void setDabingchongsuan3(Float dabingchongsuan3) {
        this.dabingchongsuan3 = dabingchongsuan3;
    }
    ...
    public boolean equals(Object that) {
        ...
        HiomsTreatmentTm other = (HiomsTreatmentTm) that;
        return (this.getJiuzhenbianhao() == null ? other.getJiuzhenbianhao() == null : this.getJiuzhenbianhao().equals(other.getJiuzhenbianhao()))
            ...
            && (this.getBenciqiandabingleiji2() == null ? other.getBenciqiandabingleiji2() == null : this.getBenciqiandabingleiji2().equals(other.getBenciqiandabingleiji2()))
            && (this.getDabingchongsuan2() == null ? other.getDabingchongsuan2() == null : this.getDabingchongsuan2().equals(other.getDabingchongsuan2()))
            && (this.getBenciqiandabingleiji3() == null ? other.getBenciqiandabingleiji3() == null : this.getBenciqiandabingleiji3().equals(other.getBenciqiandabingleiji3()))
            && (this.getDabingchongsuan3() == null ? other.getDabingchongsuan3() == null : this.getDabingchongsuan3().equals(other.getDabingchongsuan3()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBenciqiandabingleiji2() == null) ? 0 : getBenciqiandabingleiji2().hashCode());
        result = prime * result + ((getDabingchongsuan2() == null) ? 0 : getDabingchongsuan2().hashCode());
        result = prime * result + ((getBenciqiandabingleiji3() == null) ? 0 : getBenciqiandabingleiji3().hashCode());
        result = prime * result + ((getDabingchongsuan3() == null) ? 0 : getDabingchongsuan3().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", benciqiandabingleiji2=").append(benciqiandabingleiji2);
        sb.append(", dabingchongsuan2=").append(dabingchongsuan2);
        sb.append(", benciqiandabingleiji3=").append(benciqiandabingleiji3);
        sb.append(", dabingchongsuan3=").append(dabingchongsuan3);
